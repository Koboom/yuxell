const Kunde = require("./backend/models/kunde")
...
const { printBookingHistory, printZimmerBuchungHistory } = require("./backend/lib/printBooking-history")
const {kundeDatabase, hotelDatabase, driverDatabase, restaurantDatabase, zimmernDatabase} = require("./backend/database")
